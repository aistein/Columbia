...
@.str = private unnamed_addr constant [15 x i8] c"nums: %d, %d \0A\00", align 1

; Function Attrs: nounwind ssp uwtable
define void @foo(i32, i32, i32) #0 {
  ...
  call void @bar(i32 7, i32 12)
  ret void
}

; Function Attrs: nounwind ssp uwtable
define void @bar(i32, i32) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i32 %5, i32 %6)
  ret void
}
